...
const TAB_REGISTRY = {
  ...
  '/cash': [
    ...
    { code: 'tx', name: 'Транзакции' },
    { code: 'cashflow', name: 'Кэш-флоу (ДДС)' },
    { code: 'pnl', name: 'P&L' },
    { code: 'obligations', name: 'Обязательства' },
    { code: 'wallets', name: 'Кошельки' },
    { code: 'dicts', name: 'Справочники' },
  ],
  '/purchase': [
    { code: 'orders', name: 'Заявки' },
    { code: 'suppliers', name: 'Поставщики' },
    { code: 'settlements', name: 'Взаиморасчёты' },
    { code: 'act', name: 'Акт сверки' },
    { code: 'prices', name: 'Цены' },
    { code: 'specs', name: 'Спецификации' },
  ],
  '/stock': [
    { code: 'receiving', name: 'Приёмка сегодня' },
    { code: 'issue', name: 'Остатки и передача' },
    { code: 'writeoff', name: 'Списание' },
    // Здесь живут корректировка остатка и пересчёт. Это право менять цифру
    // остатка: у кого есть эта вкладка, тот и подтверждает списания.
    { code: 'inventory', name: 'Резюме / Остатки' },
    { code: 'summary', name: 'Итоги дня' },
  ],
  '/complaints': [
    { code: 'dash', name: 'Дашборд' },
    { code: 'list', name: 'Список' },
    { code: 'settings', name: 'Справочник' },
  ],
  '/hr': [
    // Не экран, а право: суммы «Начислено» и прогноз ФОТ в табеле. Табель ведут
    // двое — начальнику смены нужны часы, начальнику производства ещё и деньги,
    // у него лимит. Одной вкладкой «Табель» их не различить, отсюда отдельная
    // галочка. Тем, у кого открыта Зарплата, Выплаты или Дашборд, она не нужна:
    // деньги им видно и так.
    { code: 'ts_money', name: 'Суммы в табеле (начислено, прогноз)' },
