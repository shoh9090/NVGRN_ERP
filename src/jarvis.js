...
const LOG_KINDS = ['ai', 'voice', 'remind_silent', 'morning', 'remind_no_due', 'violation_no_due', 'due_set', 'due_moved', 'remind_mention', 'violation_mention', 'remind_overdue', 'violation_overdue', 'remind_stale', 'reply'];
