    ...
    box.append(
      ...
      sec('Что включено', null, [
        el('div', { class: 'jv-switches' }, [
          ...
          // «Включено» и «работает» — разные вещи: без ключа распознавания
          // галочка стоит, а голосовое не расшифровывается. Говорим прямо.
          onoff('Голосовые', voiceOn, (s.voice || {}).ready
