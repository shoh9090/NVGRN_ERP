...
(function () {
  ...
  const SHEET_ABOUT = {
    retail: 'Только розница. Премиум-сегмент: мытая и очищенная зелень',
    horeca250: 'Мытая и очищенная зелень. Формат для тех, кому 500 г много',
    horeca500: 'Крупный формат HoReCa. Премиум: мытая и очищенная зелень',
    salads: 'Смеси зелени для розницы и HoReCa, включая боксы',
    bunches: 'Пучковая продукция и горшки — в упаковке и без',
    culinary: 'Второй сорт для готовки — внешний вид не важен',
    dehkan: 'Немытая зелень: с поля сразу в упаковку',
    cutveg: 'Зелень и овощи машинной резки, разные виды нарезки',
  };
