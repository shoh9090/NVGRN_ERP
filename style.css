...
(function () {
  ...
  const ru = (s) => { const d = new Date(s); return d.toLocaleString('ru-RU', { day: 'numeric', month: 'short', hour: '2-digit', minute: '2-digit' }); };
  ...
  function render() {
    ...
    panel.appendChild(el('div', { class: 'bell-head' }, [
      el('span', {}, 'Уведомления'),
      el('button', { class: 'bell-readall', onclick: markAll }, 'Прочитать все'),
    ]));
    ...
    for (const n of items) {
      ...
      list.appendChild(el('a', {
        class: 'bell-item' + (n.is_read ? '' : ' unread'),
